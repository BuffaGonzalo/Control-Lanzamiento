...
Atención!!! -> Para la utilización del código copiar los archivos Qt y mbed en las respectivas carpetas de los proyectos, si se intenta compilar los archivos de mbed sin estar en la carpeta del proyecto devolvera un error.
